function D = generate_cyc_difference_matrix_for_image(sz, varargin)
% D = generate_first_difference_matrix_for_image(sz, {dif_order, spacing})
% sz -- "image" size 1x1 or 2x1 or 3x1
% dif_order -- 1 or 2. 1st or 2nd derivative
% spacing -- size of pixel in physical units
%
% Creates derivative matrix, if IMG is the image or volume, then
% G = D * IMG(:); 
